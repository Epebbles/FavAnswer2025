    ...
    return (
        <View style={styles.container}>
            <ScrollView style={styles.main}>
                ...
                <Text style={styles.textHeader}>Interpretation and Definitions</Text>
                <Text style={styles.textHeader2}>Interpretation</Text>
                <Text style={styles.text}>
                    The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                </Text>
                <Text style={styles.textHeader2}>Definitions</Text>
                <Text style={styles.text}>
                ...
                <View style={styles.indent}>
                    ...
                    <Text style={styles.text}>
                        <Text style={styles.bold}>Application</Text> refers to FavAnswer, the software program provided by the Company.
                    </Text>
                    <Text style={styles.text}>
                        <Text style={styles.bold}>Company</Text> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ConvertClick LLC, San Francisco, CA.
                    </Text>
                    <Text style={styles.text}>
                        <Text style={styles.bold}>Account</Text> means a unique account created for You to access our Service or parts of our Service.
                    </Text>
                    ...
                    <Text style={styles.text}>
                        <Text style={styles.bold}>Third-party Social Media Service</Text> refers to any website or any social network website through which a User can log in or create an account to use the Service.
                    </Text>
                    <Text style={styles.text}>
                ...
                <Text style={styles.textHeader}>Collecting and Using Your Personal Data</Text>
                <Text style={styles.textHeader2}>Types of Data Collected</Text>
                <Text style={styles.textHeader3}>Personal Data</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textHeader3}>Usage Data</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textHeader3}>Information from Third-Party Social Media Services</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textHeader2}>Use of Your Personal Data</Text>
                <Text style={styles.text}>
                ...
                <View style={styles.indent}>
                    ...
                    <Text style={styles.text}>
                        <Text style={styles.bold}>With business partners:</Text> We may share Your information with Our business partners to offer You certain products, services or promotions.communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.
                    </Text>
                    <Text style={styles.text}>
                        <Text style={styles.bold}>With other users:</Text> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You and view Your profile.
                    </Text>
                    <Text style={styles.text}>
                ...
                <Text style={styles.textHeader2}>Retention of Your Personal Data</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textHeader2}>Transfer of Your Personal Data</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textHeader2}>Delete Your Personal Data</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textHeader2}>Disclosure of Your Personal Data</Text>
                <Text style={styles.textHeader3}>Business Transactions</Text>
                <Text style={styles.text}>
                    If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                </Text>
                <Text style={styles.textHeader3}>Law enforcement</Text>
                <Text style={styles.text}>
                    Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                </Text>
                <Text style={styles.textHeader3}>Other legal requirements</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textHeader2}>Security of Your Personal Data</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.textHeader}>Links to Other Websites</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.text}>
                    We will let You know via email and/or a prominent notice on Our Privacy Policy, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.
                </Text>
                <Text style={styles.text}>
